...
7. `migration_org_write_guard.sql` — editing an org missing from the DB errors instead of silently no-oping
...
`migration.sql`, then 001–005 follow the quick-path order above
